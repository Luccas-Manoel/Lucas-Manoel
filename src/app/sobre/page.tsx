...
const SobrePage = () => {
  ...
  useEffect(() => {
    ...
    // As animações e lógicas pesadas só rodam quando o loading termina
    if (!isLoading) {
        const typingData = [
        ...
        const heroObserver = new IntersectionObserver((entries) => {
          if (entries[0].isIntersecting && !isTypingStarted) {
            isTypingStarted = true; // Garante que a digitação só comece uma vez
        ...
        const scrollObserver = new IntersectionObserver((entries) => {
          entries.forEach(entry => {
            ...
            // Se o elemento NÃO está visível, remove a classe para reanimar depois.
            else {
  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        /* CSS do loader (pode colar junto com o resto do CSS) */
        .loader-container {
            display: flex;
        ...
        /* Colar o resto do seu CSS abaixo */
       :root {
            --bg-primary: #FEFEFE;
            --bg-secondary: #FAF7F0;
            --text-primary: #2C1810;
      ...
      {isLoading ? (
        <main>
          <div className="loader-container">
            <i className="fas fa-spinner loader-icon"></i>
          </div>
        </main>
      ) : (
        <main>
                ...
                <div className="container hero-content">
                    <div className="hero-text">
                        ...
                        <div className="social-links">
                            ...
                            <a href="#" className="social-link" title="X (Twitter)"><i className="fab fa-x-twitter"></i></a>
                ...
                <div className="container">
                    ...
                    <div className="project-card fade-in">
                        ...
                        <div className="project-links">
                            <a href="#" className="project-link link-primary"><i className="fas fa-external-link-alt"></i> Ver Projeto</a>
                            <a href="#" className="project-link link-secondary"><i className="fab fa-github"></i> Código no GitHub</a>
                        </div>
                    </div>
                </div>
            </section>
